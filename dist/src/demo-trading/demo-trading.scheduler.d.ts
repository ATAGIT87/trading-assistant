...
export declare class DemoTradingScheduler {
    ...
    constructor(demoTradingService: DemoTradingService, signalsService: SignalsService, marketDataService: MarketDataService, backtestingService: BacktestingService, telegramNotificationService: TelegramNotificationService);
