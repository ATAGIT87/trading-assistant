...
exports.DemoTradingModule = DemoTradingModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([demo_position_entity_1.DemoPosition]), signals_module_1.SignalsModule, market_data_module_1.MarketDataModule],
        providers: [demo_trading_service_1.DemoTradingService],
        controllers: [demo_trading_controller_1.DemoTradingController],
        exports: [demo_trading_service_1.DemoTradingService],
    })
], DemoTradingModule);
