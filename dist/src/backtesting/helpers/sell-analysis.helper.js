...
exports.analyzeSellTrades = analyzeSellTrades;
function analyzeSellTrades(trades) {
    ...
    console.log("\n========== SELL ADX >= 40 ==========");
    console.table(highAdxSellTrades.map((trade) => ({
...
//# sourceMappingURL=sell-analysis.helper.js.map